...
class TableListView extends GetView<TableController> {
            ...
            children: [
              ...
              Obx(() {
                ...
                return Padding(
                  ...
                  child: Text(
                    "Showing ${controller.tables.length} items",
                  ...
                  child: Obx(
                    () {
                      ...
                      return ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          return _categoryItem(controller.tables[index]);
                        },
                      );
                    },
                  ),
  ...
  Widget _categoryItem(TableEntity category) {
    return Container(
      padding: EdgeInsets.symmetric(
