...
class MenuItemEditView extends GetView<MenuItemEditController> {
  const MenuItemEditView({super.key});
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Obx(
                              () {
                                String source = controller.currentImage.value;

                                if (controller.selectedImage.value != null) {
                                  source = controller.selectedImage.value!.path;
                                }
